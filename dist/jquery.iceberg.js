/**
 * @version v1.7.0
 * @link https://github.com/sutras/iceberg#readme
 * @license MIT
 */
...
(function (global, factory) {
    ...
    */
    ...
    $__default['default'].each({
        ...
        $__default['default'].fn[name] = function() {
            return this.animate.apply( this, $__default['default'].merge( [obj], arguments ) );
        };
    });
    ...
    */
    ...
    $__default['default'].event.special.wheel = {
        delegateType: wheel,
        bindType: wheel,
    ...
    */
    ...
    // 把iceberg注册为$.fn插件
    var iceberg = $__default['default'].fn.iceberg = function( options ) {
        if ( typeof options === 'string' ) {
            return iceberg.methods[ options ]( this, $__default['default'].makeArray( arguments ).slice(1) );
        }

        return this.each(function() {
            if ( !$__default['default'].data(this, 'iceberg') ) {
                $__default['default'].data( this, 'iceberg', getIcebergInstance( this, options || {} ) );
            }
        });
    };
    ...
    function getIcebergInstance( elem, options ) {
        var opts = $__default['default'].extend( {}, defaults, options ),
            Class = effect[ opts.effect ];

        if ( typeof Class !== 'function' ) {
            error$1( 'This effect does not exist: ' + opts.effect  + '.');
            return;
        }

        // 根据effect效果来实例化对应的类
        return new Class( elem, opts, $__default['default'].isPlainObject( options ) ? options : {} );
    }
    ...
    iceberg.extend = function( subType, superType, _constructor, proto ) {
        ...
        if ( subType in effect ) {
            return error$1('The same effect already exists: ' + subType + '.');
        }
    ...
    */
    ...
    function getEl( val, context ) {
        ...
        return $__default['default']( val, need ? context : null );
    }
    ...
    */
    iceberg.extend('base', '', function( container, opts, srcOptions ) {
        ...
        this.$container = $__default['default']( container );

        // 滑块的包装层
        this.$wrapper = $__default['default']( opts.wrapper, container );
        ...
        cloneSlide: function( isMarquee ) {
            ...
            if ( opts.loop && this.pageNum > 1 ) {
                ...
                this.$srcSlide.each(function(index, slide ) {
                    $__default['default'](this).attr( that.options.slideDataName, index );
                });
        ...
        getSlideSize: function() {
            ...
            this.$srcSlide.each(function() {
                var width = $__default['default'](this).width(),
                    height = $__default['default'](this).height();
                if ( width > selfW ) {
                    selfW = width;
                    slideW = $__default['default'](this).outerWidth(true);
                }
                if ( height > selfH ) {
                    selfH = height;
                    slideH = $__default['default'](this).outerHeight(true);
                }
            });
            return {
                width: {
        ...
        resize: function() {
            this.resizeHandlerProxy = throttle( $__default['default'].proxy(this.resizeHandler, this), this.options.interval );
            $__default['default'](window).resize( this.resizeHandlerProxy );
        },

        unresize: function() {
            $__default['default'](window).off('resize', this.resizeHandlerProxy);
        },
        ...
        mousewheel: function() {
            ...
            if ( wheel ) {
                ( typeof wheel === 'boolean' ? this.$container : $__default['default']( wheel, this.$container ) )
        ...
        animationPreprocess: function( offset, isInit ) {
            ...
            if ( !(opts.disabled && (this.leftEdge || this.rightEdge)) ) {
                ...
                // 执行动画
                this.animation( $__default['default'].proxy( this.done, this, isInit ), isInit );
            }
        },

        animation: function() {
            error$1('This method must be redefined: animation.');
        },
        ...
        play: function() {
            ...
            if ( !this.autoPlayTimer &&
                    ...
                    this.enough &&
                    this.allowedPlay ) {
                this.autoPlayTimer = setTimeout( $__default['default'].proxy( function() {
        ...
        autoPlay: function() {
            ...
            if ( this._autoPlay && opts.mouseoverStop ) {
                this.$container
                    ...
                    .add( this.$next )
                    .add( this.$pageItem )
                    .hover( $__default['default'].proxy( function( ev ) {
                        this.allowedPlay = false;
                        this.stop();
                    }, this ), $__default['default'].proxy( function( ev ) {
                        this.allowedPlay = true;
                        this.play();
                    }, this ));
            }
    ...
    iceberg.methods = {
        goto: function( jq, index ) {
            return jq.each(function() {
                var obj = $__default['default'].data( this, 'iceberg' );
                obj.goto( index );
            });
        },
        prev: function( jq ) {
